        ...
        <DIV id=main-content>
            ...
            <UL class=shortcut-buttons-set>
                <LI><A class=shortcut-button
                        href="update.php?mode=add<?php if ($param <> "") echo "&" . $param; ?>"><SPAN><IMG alt=icon
        ...
        ?>
            ...
            ?>
                ...
                <DIV class=content-box-content>
                    <DIV id=tab1 class="tab-content default-tab">
                        ...
                        <form name="form2" method="post" action="confirm.php" onSubmit="return check_select(this)">
                            <TABLE>
                                <THEAD>
                                    <TR>
                                        <TH width="5%"><INPUT class=check-all type=checkbox name="ca" value="true"
                                                onClick="chkAll(this.form, 'del[]', this.checked)"></TH>
                                        <TH width="5%" <?php Show_Sort_bg("user_id", $orderby) ?>> <?php
                                            ...
                                            &nbsp;</TH>
                                        <TH width="17%" <?php Show_Sort_bg("name", $orderby) ?>>
                                            <?php Show_Sort_new("name", "ชื่อ-นามสกุล", $orderby, $sortby, $page, $param2); ?>
                                            &nbsp;</TH>
                                        <TH width="18%" <?php Show_Sort_bg("username", $orderby) ?>>
                                            <?php Show_Sort_new("username", "ชื่อเข้าใช้งาน", $orderby, $sortby, $page, $param2); ?>
                                            &nbsp;</TH>
                                        <TH width="17%" <?php Show_Sort_bg("password", $orderby) ?>>
                                            <?php Show_Sort_new("password", "รหัสผ่าน", $orderby, $sortby, $page, $param2); ?>
                                            &nbsp;</TH>
                                        <TH width="14%">
                                            <div align="center"><a>กลุ่มผู้ใช้งาน</a></div>
                                        </TH>
                                        <TH width="12%" nowrap>
                                            <div align="center"><a>การอนุญาต</a></div>
                                        </TH>
                  ...
                  ?>
                                    <TR>
                                        <TD><INPUT type=checkbox name="del[]" value="<?php echo $rec[$PK_field]; ?>">
                                        </TD>
                                        ...
                                        <TD>
                                            <div align="center"><a
                                                    href="../user_group/update.php?mode=update&<?php echo $PK_field; ?>=<?php echo $rec[$PK_field]; ?>&<?php echo $param2; ?>"><?php if (userGroup($conn, $rec[$PK_field]) != "") {
                                                                                                                                                                            echo userGroup($conn, $rec[$PK_field]);
                                                                                                                                                                          } else {
                                                                                                                                                                            echo "Group";
                                                                                                                                                                          } ?></a>
                                            </div>
                                        ...
                                        <TD align="center">
                                            <div align="center"><a
                                                    href="../user_p/update.php?mode=update&<?php echo $PK_field; ?>=<?php echo $rec[$PK_field]; ?><?php //echo get_pre_param($a_param);
                                                                                                                                              ?>"><img
                                                        src="../images/icons/hammer_screwdriver.png" width="16"
                                                        height="16" border="0"></a></div>
                                        </TD>
                                        <TD>
                                            <!-- Icons -->
                                            <A title=Edit
                                                href="update.php?mode=update&<?php echo $PK_field; ?>=<?php echo $rec[$PK_field];
                                                                                            if ($param <> "") { ?>&<?php echo $param;
                                                                                                                  } ?>"><IMG
                                                    alt=Edit src="../images/pencil.png"></A> <A title=Delete
                                                href="#"></A></TD>
                                        <TD><A title=Delete href="#"><IMG alt=Delete src="../images/cross.png"
                                                    onClick="confirmDelete('?action=delete&<?php echo $PK_field; ?>=<?php echo $rec[$PK_field]; ?>','User  <?php echo $rec[$PK_field]; ?> : <?php echo $rec["name"]; ?>')"></A>
                                        </TD>
                                    </TR>
                                    <?php  } ?>
                                </TBODY>
