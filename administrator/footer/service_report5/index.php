	...
	?>
      ...
      <TBODY>
        ...
        <TR>
          ...
          <TD style="vertical-align:middle;"><?php $chaf = eregi_replace("/","-",$rec["sv_id"]); ?><div align="center"><span class="text"><a href="../../upload/return/<?php echo $chaf;?>.pdf" target="_blank"><? echo $rec["sv_id"] ; ?></a></span></div></TD>
          ...
          <TD style="vertical-align:middle;"><!-- Icons -->
            <div align="center"><A title=Edit href="update.php?mode=update&<? echo $PK_field; ?>=<? echo $rec["$PK_field"]; if($param <> "") {?>&<? echo $param; }?>"><IMG src="../images/icons/paper_content_pencil_48.png" alt=Edit width="25" height="25" title="แก้ไขรายงานแจ้งซ่อม"></A><a href="../../upload/return/<?php echo $chaf;?>.pdf" target="_blank"><img src="../images/icon2/backup.png" width="25" height="25" title="ดาวน์โหลดรายงานช่างซ่ิอม" style="margin-left:10px;"></a></div></TD>
