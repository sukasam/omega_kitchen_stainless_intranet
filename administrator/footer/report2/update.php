          ...
          <tr>
            <td><table class="formFields" cellspacing="0" width="100%">
              <tr >
                ...
                <td><input name="group_type_id" type="text" id="group_type_id"  value="<? echo $group_type_id; ?>" size="60"></td>
              </tr>
              <tr >
                <td nowrap class="name">ชื่้อกลุ่ม</td>
                <td><input name="group_name" type="text" id="group_name"  value="<? echo $group_name; ?>" size="60"></td>
              </tr>
              <? if ($_GET[mode] == "add") { ?>
              <? } ?>
              <? if ($_GET[mode] == "update") { ?>
