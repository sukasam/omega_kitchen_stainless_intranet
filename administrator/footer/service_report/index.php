      ...
      <TBODY>
        ...
        <TR>
          ...
          <TD style="vertical-align:middle"><div align="center">
            <? if($rec["supply"]==0) {?>
            <a href="../service_report/?cc=<? echo $rec[$PK_field]; ?>&tt=<? echo $rec["supply"]; ?>&page=<? echo $_GET['page']; ?>&<? echo $FK_field; ?>=<? echo $_REQUEST["$FK_field"];?>&cus_id=<?php echo $rec["cus_id"];?>"><img src="../images/icons/check0.gif" width="15" height="15"></a>
            <? } else{?>
            <a href="../service_report/?cc=<? echo $rec[$PK_field]; ?>&tt=<? echo $rec["supply"]; ?>&page=<? echo $_GET['page']; ?>&<? echo $FK_field; ?>=<? echo $_REQUEST["$FK_field"];?>&cus_id=<?php echo $rec["cus_id"];?>"><img src="../images/icons/check1.gif" width="15" height="15"></a>
            <? }?>
          </div></TD>
          <TD style="vertical-align:middle"><div align="center">
            <? if($rec["st_setting"]==0) {?>
            <a href="../service_report/?b=<? echo $rec[$PK_field]; ?>&s=<? echo $rec["st_setting"]; ?>&page=<? echo $_GET['page']; ?>&<? echo $FK_field; ?>=<? echo $_REQUEST["$FK_field"];?>&cus_id=<?php echo $rec["cus_id"];?>"><img src="../icons/status_on.gif" width="10" height="10"></a>
            <? } else{?>
            <a href="../service_report/?b=<? echo $rec[$PK_field]; ?>&s=<? echo $rec["st_setting"]; ?>&page=<? echo $_GET['page']; ?>&<? echo $FK_field; ?>=<? echo $_REQUEST["$FK_field"];?>&cus_id=<?php echo $rec["cus_id"];?>"><img src="../icons/status_off.gif" width="10" height="10"></a>
            <? }?>
          </div></TD>
