<?php    
	...
	if ($_GET["action"] == "apps") { 
	   ...
	   if($appID == '') $appID = '0';
	   $sql_status = "update $tbl_name set approve = '".$cc."', stock_approve = '".$appID."', stock_approve_date = '".date("Y-m-d")."' where $PK_field = '".$ids."'";
...
<LI><A class=shortcut-button href="../group_stock_order_stockin/"><SPAN><IMG  alt=icon src="../images/btn_back.gif"><BR>
  กลับ</SPAN></A></LI>
</UL>
