...
<UL class=shortcut-buttons-set>
	<LI><A class=shortcut-button href="../schedule_order/index.php"><SPAN><IMG  alt=icon src="../images/icon2/templatemanager.png"><BR>
    ตารางงานเปิด<br>ใบสั่งผลิตสินค้า</SPAN></A></LI>
	<LI><A class=shortcut-button href="../schedule_orderclosed/index.php"><SPAN><IMG  alt=icon src="../images/icon2/templatemanager.png"><BR>
    ตารางงานปิด<br>ใบสั่งผลิตสินค้า</SPAN></A></LI>
    <?php  
	if ($FR_module <> "") { 
		...
		for ($i = 1; $i <= $days_in_month; $i++) {
			...
			echo "<div align=\"right\"><span class=\"toprightnumber\">\n<a href=\"javascript:void(0);\" onclick=\"windowOpener('500', '650', '', 'schedule_list.php?day=$i&amp;month=$link_month&amp;year=$_GET[year]$getLocontract$getSr_ctype');\">$i</a>&nbsp;</span></div>\n";
				...
				echo "<div align=\"left\"><span class=\"eventinbox\">\n";
					...
					echo get_orderproduct_closed($conn,$_GET['year'].'-'.sprintf("%02d",$link_month).'-'.sprintf("%02d",$i),$_GET['loccontact'],$_GET['sr_ctype']);
