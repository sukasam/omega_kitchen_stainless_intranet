				...
				<DIV class=content-box-header align="right" style="padding-right:15px;">
					...
					<div style="float:right;padding-top:0px;">
						<form name="form1" method="get" action="index.php">
							...
							?>
							<a href="index.php?<?php if (isset($_GET['app_id'])) {
													echo 'app_id=' . $_GET['app_id'] . '&';
												} ?><?php echo $param2; ?>">แสดงทั้งหมด</a>
							<?php
							/*$a_not_exists = array();
			post_param($a_param,$a_not_exists);*/
					...
					<div style="float:right;margin-right:20px;padding-top:0px;">
						...
						<select name="catalog_master" id="catalog_master" style="height:24px;" onChange="MM_jumpMenu('parent',this,0)">
							<option value="index.php?app_id=4" <?php if ($_GET['app_id'] == 4) {
																	echo "selected";
																} ?>>ทั้งหมด</option>
							...
							<TABLE>
								<THEAD>
									<TR>
										...
										<TH width="15%">
											<div align="center">การยืนยัน</div>
										</TH>
										<TH width="10%">
											<div align="center">ดาวน์โหลด</div>
										</TH>
									</TR>
								</THEAD>
								<TFOOT>
								...
								<TBODY>
									...
									?>
										<TR>
											...
											<TD style="vertical-align: middle;">
												<div align="center"><a href="../../upload/first_order/<?php echo $chaf; ?>.pdf" target="_blank"><img src="../images/icon2/download_f2.png" width="20" height="20" border="0" alt=""></a></div>
											</TD>
