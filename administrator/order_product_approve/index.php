...
<UL class=shortcut-buttons-set>
  <!-- <LI><A class=shortcut-button href="update.php?mode=add<?php     if ($param <> "") echo "&".$param; ?>"><SPAN><IMG  alt=icon src="../images/pencil_48.png"><BR>
    ...
    <LI><A class=shortcut-button href="../order_product_approve/"><SPAN><IMG  alt=icon src="../images/icons/icon-48-user.png"><BR>
	...
	<LI><A class=shortcut-button href="../order_product/"><SPAN><IMG  alt=icon src="../images/icons/icon-48-section.png"><BR>
    ใบสั่งผลิตสินค้า<br><br></SPAN></A></LI>
    <LI><A class=shortcut-button href="../order_product_approve/"><SPAN><IMG  alt=icon src="../images/icons/icon-48-user.png"><BR>
    อนุมัติใบสั่งผลิตสินค้า</SPAN></A></LI>
    <?php     
	if ($FR_module <> "") { 
    ...
    <TABLE>
      <THEAD>
        <TR>
		  ...
		  <TH width="5%"><div align="center"><a>การยืนยัน</a></div></TH>
...
//					break;
        ...
        <TR>
          ...
          <TD style="vertical-align:middle;"><span class="text"><?php     echo get_cname_fopj($conn,$rec["cus_id"])."<br><strong>สถานที่ติดตั้ง :</strong> ".get_csetup_fopj($conn,$rec["cus_id"]); ?></span></TD>
         ...
         <select name="jumpMenu" id="jumpMenu" onChange="MM_jumpMenu('parent',this,0)" style=" <?php  if($rec["approve"] == "0"){echo "background:#FF0;color:#000;";}elseif($rec["approve"] == "1"){echo "background:#090;color:#FFF;";}elseif($rec["approve"] == "3"){echo "background:#C60;color:#FFF;";}else{echo "background:#F00;color:#FFF;";}?>">
		  ...
		  <TD style="vertical-align:middle;"><?php     $chaf = preg_replace("/\//","-",$rec["sv_id"]); ?><div align="center"><span class="text"><a href="../../upload/order_product/<?php     echo $chaf;?>.pdf" target="_blank"><img src="../images/icon2/backup.png" width="25" height="25" title="" style="margin-left:10px;"></a></span></div></TD>
          </TR>  
		<?php     }?>
      </TBODY>
    </TABLE>
