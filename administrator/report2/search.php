...
while ($row_cus = @mysqli_fetch_array($qu_cus)) {
    ?>
		 <tr>
            <td><A href="javascript:void(0);" onclick="get_customer('<?php echo $row_cus['fo_id']; ?>','<?php echo $row_cus['loc_name']; ?>');"><?php if (!empty($row_cus['cusid'])) {echo $row_cus['cusid'] . " | ";}?><?php echo $row_cus['cd_name'] . " ( " . $row_cus['loc_name'] . " )"; ?></A></td>
          </tr>
		<?php
}
?>
