...
<head>
    ...
    <title>เลือกตามการรับอะไหล่เพื่อผลิตเข้าสต๊อค</title>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tbreport">
        ...
        <tr>
            ...
            <th colspan="4" style="text-align:left;font-size:12px;">บริษัท โอเมก้า คิทเช่น สแตนเลส จำกัด<br />
                ...
                รายงานการรับอะไหล่เพื่อผลิตเข้าสต๊อค</th>
            ...
            <?php if ($_REQUEST['sh4'] == 1 || $_REQUEST['sh5'] == 1 || $_REQUEST['sh6'] == 1) {?><th width="30%">
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tbreport">
                    ...
                    <tr>
                        ...
                        <?php if ($_REQUEST['sh4'] == 1) {?><td style="border-bottom:none;" width="20%">
                            <strong>รหัสอะไหล่</strong></td><?php }?>

                        <?php if ($_REQUEST['sh5'] == 1) {?><td style="border-bottom:none;" width="40%">
                            <center><strong>รายการอะไหล่</strong></center>
                        </td>

                        <td style="border-bottom:none;" width="20%">
                            <center><strong>จำนวน</strong></center>
                        </td>
                        <?php }?>

                        <?php if ($_REQUEST['sh6'] == 1) {?><td style="border-bottom:none;" width="20%">
                            <strong>ราคาซื้อ</strong></td><?php }?>
...
$sql = "SELECT * FROM " . $dbservice . " as st, " . $dbservicesub . " as stp WHERE st.sub_id = stp.id_bill " . $condi . " " . $daterriod . " GROUP BY st.sub_id ORDER BY st.sub_id DESC";
...
while ($row_bill = @mysqli_fetch_array($qu_fr)) {
    ...
    ?>
        ...
        <tr>
            ...
            <?php /*if ($_REQUEST['sh2'] == 1) { ?><td>
    <?php echo $row_bill['sub_address'] . ' / ' . $row_bill['sub_tel']; ?></td><?php  } */?>
        ...
        while ($row = @mysqli_fetch_array($qu_pfirst)) {
            ...
            ?>
                    ...
                    <tr>
                        ...
                        <?php if ($_REQUEST['sh4'] == 1) {?><td style="border-bottom:none;" width="20%">
                            <?php echo get_sparpart_id($conn, $row['sparpart_id']); ?></td><?php }?>

                        <?php if ($_REQUEST['sh5'] == 1) {?><td align="left" style="border-bottom:none;" width="40%">
                            <?php echo get_sparpart_name($conn, $row['sparpart_id']); ?></td>

                        <td align="center" style="border-bottom:none;" width="20%">
                            <?php echo $row['sparpart_qty']; ?></td>

                        <?php }?>

                        <?php if ($_REQUEST['sh6'] == 1) {?><td align="right" style="border-bottom:none;" width="20%">
                            <?php echo number_format($row['sparpart_unit_price'], 2); ?></td><?php }?>
        ...
        ?>
            ...
            <?php if ($_REQUEST['sh8'] == 1) {?><td style="padding:0;">
                <?php echo get_username($conn, $row_bill['create_by']); ?></td><?php }?>
...
?>
        ...
        <tr>
            ...
            <td colspan="9" style="text-align:right;">
                <strong>จำนวนการรับเข้าสต็อคทั้งหมด&nbsp;&nbsp;<?php echo $sum; ?>&nbsp;&nbsp;รายการ&nbsp;&nbsp;</strong>
            </td>
...
-->
        ...
        <tr>
            ...
            <td colspan="8" style="text-align:right;">
                <strong>คิดเป็นมูลค่ารวมทั้งสิ้น&nbsp;&nbsp;<?php echo number_format($sumTotalAll + $moneyTCTota, 2); ?>&nbsp;&nbsp;บาท&nbsp;&nbsp;</strong>
            </td>
