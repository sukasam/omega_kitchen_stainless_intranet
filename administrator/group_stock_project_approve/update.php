<?php    
	...
	if ($_POST["mode"] <> "") { 
		...
		if ($_POST["mode"] == "update" ) { 
				...
				@mysqli_query($conn,"UPDATE `s_group_stock_project_bill` SET `stock_approve_date` = '".$dateApprove."' WHERE `sub_id` = $id;");

			include_once("../mpdf54/mpdf.php");
			include_once("../group_stock_project_stockin/form_stockin.php");
			$mpdf=new mPDF('UTF-8'); 
			$mpdf->SetAutoFont();
			$mpdf->WriteHTML($form);
