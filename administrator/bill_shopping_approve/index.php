...
-->
    <LI><A class=shortcut-button href="../bill_shipping/"><SPAN><IMG  alt=icon src="../images/icons/icon-48-section.png"><BR>
    ใบจัดส่งสินค้า<br><br></SPAN></A></LI>
    <?php
	if ($FR_module <> "") { 
...
<DIV id=tab1 class="tab-content default-tab"><!-- This is the target div. id must match the href of this div's tab -->
  <form name="form2" method="post" action="confirm.php" onSubmit="return check_select(this)">
	...
	?>
            ...
            &nbsp;</TH>
          <TH width="9%"><div align="center"><a>Shipping ID</a></div></TH>
