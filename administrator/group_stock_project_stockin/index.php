<?php    
	...
	if($_GET["action"] == "delete"){
		...
		if ($code == "1") {
			...
			$sql2 = "select * from s_group_stock_project_bill_pro where id_bill = '".$_GET[$PK_field]."'";
			...
			$sql = "delete from s_group_stock_project_bill_pro  where id_bill = '".$_GET[$PK_field]."'";
			@mysqli_query($conn,$sql);	
...
<UL class=shortcut-buttons-set>
  <LI><A class=shortcut-button href="../group_stock_project/index.php"><SPAN><IMG  alt=icon src="../images/menu/mn_serting06.png"><BR>
    สต๊อคสินค้า</SPAN></A></LI>
    <LI><A class=shortcut-button href="../group_stock_project/update.php"><SPAN><IMG  alt=icon src="../images/menu/mn_serting21.png"><BR>
	...
	<LI><A class=shortcut-button href="../group_stock_project_approve/"><SPAN><IMG  alt=icon src="../images/icons/icon-48-user.png" width="60"><BR>
    อนุมัติรับเข้าสต็อก</SPAN></A></LI>
    <LI><A class=shortcut-button href="../report/?mid=16&act=14"><SPAN><IMG  alt=icon src="../images/menu/mn_serting23.png"><BR>
      ...
      <TBODY>
        ...
        <TR>
		  ...
		  <TD style="vertical-align:middle"><div align="center">
            ...
            <a href="../group_stock_project_stockin/?b=<?php  echo $rec[$PK_field]; ?>&s=<?php  echo $rec["st_setting"]; ?>&page=<?php  echo $_GET["page"]; ?>&<?php  echo $FK_field; ?>=<?php  echo $_REQUEST["$FK_field"];?>&cus_id=<?php  echo $rec["cus_id"];?>"><img src="../icons/status_on.gif" width="10" height="10"></a>
            <?php  } else{?>
            <a href="../group_stock_project_stockin/?b=<?php  echo $rec[$PK_field]; ?>&s=<?php  echo $rec["st_setting"]; ?>&page=<?php  echo $_GET["page"]; ?>&<?php  echo $FK_field; ?>=<?php  echo $_REQUEST["$FK_field"];?>&cus_id=<?php  echo $rec["cus_id"];?>"><img src="../icons/status_off.gif" width="10" height="10"></a>
            <?php  }?>
          </div></TD>
		  <TD><center><A title="view" href="../../upload/stockin_project/<?php echo $rec["sub_id"];?>.pdf" target="_blank"><IMG alt="view" src="../images/icon2/backup.png" width="25"></A></center></TD>
           <TD><!-- Icons -->
