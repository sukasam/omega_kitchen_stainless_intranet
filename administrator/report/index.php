...
<BODY>
    <DIV id=body-wrapper>
            ...
            <DIV class=content-box>
                ...
                <DIV class=content-box-content>
                    <DIV id=tab1 class="tab-content default-tab">
                        ...
                        <UL class=shortcut-buttons-set>
                            <LI><A class=shortcut-button href="../report/?mid=16&act=1"><SPAN><IMG alt=icon
                                            src="../images/icons/icon-48-category.png"><BR>
                                        <strong>ชื่อร้าน/ชื่อบริษัท</strong></SPAN></A></LI>
                            <LI><A class=shortcut-button href="../report/?mid=16&act=2"><SPAN><IMG alt=icon
                                            src="../images/icons/icon-48-category.png"><BR>
                                        <strong>ตามจังหวัด</strong></SPAN></A></LI>
                            <LI><A class=shortcut-button href="../report/?mid=16&act=3"><SPAN><IMG alt=icon
                                            src="../images/icons/icon-48-category.png"><BR>
                                        <strong>กลุ่มลูกค้า</strong></SPAN></A></LI>
                            <LI><A class=shortcut-button href="../report/?mid=16&act=4"><SPAN><IMG alt=icon
                                            src="../images/icons/icon-48-category.png"><BR>
                                        <strong>ตามสินค้า</strong></SPAN></A></LI>
                            <LI><A class=shortcut-button href="../report/?mid=16&act=5"><SPAN><IMG alt=icon
                                            src="../images/icons/icon-48-category.png"><BR>
                                        <strong>รุ่นเครื่อง</strong></SPAN></A></LI>
                            <LI><A class=shortcut-button href="../report/?mid=16&act=6"><SPAN><IMG alt=icon
                                            src="../images/icons/icon-48-category.png"><BR>
      ...
      <strong>ช่างติดตั้งเครื่อง</strong></SPAN></A></LI>-->
                            <LI><A class=shortcut-button href="../report/?mid=16&act=9"><SPAN><IMG alt=icon
                                            src="../images/icons/icon-48-category.png"><BR>
                                        <strong>ตามชื่่อผู้ขาย</strong></SPAN></A></LI>
                            <LI><A class=shortcut-button href="../report/?mid=16&act=10"><SPAN><IMG alt=icon
                                            src="../images/icons/icon-48-category.png"><BR>
                                        <strong>ตารางคุมสัญญา</strong></SPAN></A></LI>
                            <LI><A class=shortcut-button href="../report/?mid=16&act=11"><SPAN><IMG alt=icon
                                            src="../images/icons/icon-48-category.png"><BR>
                                        <strong>รายงานสรุป</strong></SPAN></A></LI>
                            <LI><A class=shortcut-button href="../report/?mid=16&act=12"><SPAN><IMG alt=icon
                                            src="../images/icons/icon-48-category.png"><BR>
                                        <strong>เงินประกันลูกค้าเช่า</strong></SPAN></A></LI>
                            <LI><A class=shortcut-button href="../report/?mid=16&act=13"><SPAN><IMG alt=icon
                                            src="../images/icons/icon-48-category.png"><BR>
                ...
                <DIV class=content-box-header align="right" style="padding-right:15px;display:none;">
                ...
                <DIV class=content-box-content style="display: none;">
                    <DIV id=tab1 class="tab-content default-tab">
                        <!-- This is the target div. id must match the href of this div's tab -->
                        <UL class=shortcut-buttons-set>
                            <LI><A class=shortcut-button href="../report/?mid=16&act=16"><SPAN><IMG alt=icon
                                            src="../images/icons/icon-48-category.png"><BR>
                                        <strong>การรับอะไหล่<br>เข้าสต๊อค<br></strong></SPAN></A></LI>
                            <LI><A class=shortcut-button href="../report/?mid=16&act=17"><SPAN><IMG alt=icon
                                            src="../images/icons/icon-48-category.png"><BR>
      ...
      <strong>การรับสินค้า<br>โปรเจ็คเข้าสต๊อค<br></strong></SPAN></A></LI> -->
                            <LI><A class=shortcut-button href="../report/?mid=16&act=15"><SPAN><IMG alt=icon
                                            src="../images/icons/icon-48-category.png"><BR>
            ...
            <DIV class=content-box>
                ...
                <DIV class=content-box-content>
                    <DIV id=tab1 class="tab-content default-tab">
                        <!-- This is the target div. id must match the href of this div's tab -->
                        <form action="report1.php" method="post" name="form1" id="form1" target="_blank"
                                ...
                                <fieldset>
                                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                            ...
                                            <td>
                                                <table class="formFields" cellspacing="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td width="90%"><input name="cd_name" type="text" id="cd_name"
                                                                value="" style="width:40%;"><a
                                                                href="javascript:void(0);"
                                                                onClick="windowOpener('400', '500', '', 'search.php');"><img
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span class="name">
                                                                ...
                                                                <img src="../icons/favorites_use.png" width="15"
                                                                    height="15"> ใช้งาน
                                                                &nbsp;
                                                                <input name="use" type="radio" value="1">
                                                                <img src="../icons/favorites_stranby.png" width="15"
                                                                    height="15"> Stand by
                                                                <input name="use" type="radio" value="2">
                                                                <img src="../icons/favorites_close.png" width="15"
                                                                    height="15"> ยกเลิก</span>
                                                            <input name="use" type="radio" value="3">
                                                            <img src="../icons/favorites_service.png" width="15"
                                                                height="15"> Service</span>
                                                            <!--<input name="use" type="radio" value="3"> ทั้งหมด</span>-->
                                                        </td>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="10%" nowrap class="name">เริ่มวันที่</td>
                                            <td width="90%"><input type="text" name="date_fm" readonly
                                                    value="<?php echo date("d/m/Y"); ?>" class="inpfoder" />
                                        ...
                                        <tr>
                                            ...
                                            <td width="90%"><input type="text" name="date_to" readonly
                                                    value="<?php echo date("d/m/Y"); ?>" class="inpfoder" />
                                                <script language="JavaScript">
                                                new tcal({
                                                    'formname': 'form1',
            ...
            <DIV class=content-box>
                ...
                <DIV class=content-box-content>
                    <DIV id=tab1 class="tab-content default-tab">
                        <!-- This is the target div. id must match the href of this div's tab -->
                        <form action="report2.php" method="post" name="form1" id="form1" target="_blank"
                                            ...
                                            <td>
                                                <table class="formFields" cellspacing="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td width="90%">
                                                            <select name="cd_province" id="cd_province"
                                                                class="inputselect">
                                                                <?php
                                                                    ...
                                                                    ?>
                                                                <option
                                                                    value="<?php echo $row_province['province_id']; ?>"
                                                                    <?php if ($cd_province == $row_province['province_id']) {
                                                                                                                                        echo 'selected';
                                                                                                                                    } ?>>
                                                                    <?php echo $row_province['province_name']; ?>
                                                                </option>
                                                                <?php
                                                                    }
                                                                    ?>
                                                    ...
                                                    <tr>
                                                        <td nowrap class="name">รายการแสดง</td>
                                                        <td><input name="sh1" type="checkbox" id="sh31" value="1"
                                                                checked>
                                                            ชื่อลูกค้า / บริษัท + เบอร์โทร
                                                            <input name="sh2" type="checkbox" id="sh32" value="1"
                                                                checked>
                                                            ชื่อร้าน / สถานที่ติดตั้ง
                                                            <input name="sh4" type="checkbox" id="sh34" value="1"
                                                                checked>
                                                            ประเภทลูกค้า <br>
                                                            <input name="sh5" type="checkbox" id="sh35" value="1"
                                                                checked>
                                                            กลุ่มลูกค้า
                                                            <input name="sh6" type="checkbox" id="sh36" value="1"
                                                                checked>
                                                            สินค้า
                                                            <input name="sh7" type="checkbox" id="sh37" value="1"
                                                                checked>
                                                            รุ่นเครื่อง/SN/
                                                            <input name="sh8" type="checkbox" id="sh38" value="1"
                                                                checked>
                                                            ราคาขาย/ค่าเช่า
                                                            <input name="sh9" type="checkbox" id="sh39" value="1"
                                                                checked>
                                                            วันที่ติดตั้ง
                                                            <input name="sh10" type="checkbox" id="sh40" value="1"
                                                                checked>
                                                            ผู้ขาย</td>
                                                    </tr>
                                                    <tr>
            ...
            <DIV class=content-box>
                ...
                <DIV class=content-box-content>
                    <DIV id=tab1 class="tab-content default-tab">
                        <!-- This is the target div. id must match the href of this div's tab -->
                        <form action="report3.php" method="post" name="form1" id="form1" target="_blank"
                                            ...
                                            <td>
                                                <table class="formFields" cellspacing="0" width="100%">
                                                        ...
                                                        <td width="90%">
                                                            <select name="cg_type" id="cg_type" class="inputselect">
                                                                <?php
                                                                    ...
                                                                    ?>
                                                                <option value="<?php echo $row_cgtype['group_id']; ?>"
                                                                    <?php if ($cg_type == $row_cgtype['group_id']) {
                                                                                                                                    echo 'selected';
                                                                                                                                } ?>>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><select name="ctype" id="ctype" class="inputselect">
                                                                ...
                                                                <?php
                                                                    ...
                                                                    ?>
                                                                <option value="<?php echo $row_cgcus['group_id']; ?>"
                                                                    <?php if ($ctype == $row_cgcus['group_id']) {
                                                                                                                                        echo 'selected';
                                                                                                                                    } ?>>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><select name="pro_pod" id="pro_pod" class="inputselect"
                                                                style="width:250px;">
                                                                ...
                                                                <?php
                                                                    ...
                                                                    ?>
                                                                <option
                                                                    value="<?php echo $row_qupros1['group_name']; ?>">
                                                            ...
                                                            <a href="javascript:void(0);"
                                                                onClick="windowOpener('400', '500', '', 'search_pod.php?protype=pro_pod');"><img
                                                                    src="../images/icon2/mark_f2.png" width="25"
                                                                    height="25" border="0" alt=""
                                                                    style="vertical-align:middle;padding-left:5px;"></a>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td nowrap class="name">รายการแสดง</td>
                                                        <td><input name="sh1" type="checkbox" id="sh41" value="1"
                                                                checked>
                                                            ชื่อลูกค้า / บริษัท + เบอร์โทร
                                                            <input name="sh2" type="checkbox" id="sh42" value="1"
                                                                checked>
                                                            ชื่อร้าน / สถานที่ติดตั้ง
                                                            <input name="sh3" type="checkbox" id="sh43" value="1"
                                                                checked>
                                                            ประเภทลูกค้า <br>
                                                            <input name="sh4" type="checkbox" id="sh44" value="1"
                                                                checked>
                                                            ประเภทสินค้า
                                                            <input name="sh5" type="checkbox" id="sh46" value="1"
                                                                checked>
                                                            รุ่นเครื่อง/SN/
                                                            <input name="sh6" type="checkbox" id="sh47" value="1"
                                                                checked>
                                                            ราคาขาย/ค่าเช่า

                                                            <input name="sh7" type="checkbox" id="sh49" value="1"
                                                                checked>
                                                            ผู้ขาย</td>
                                                    </tr>
                                                    <tr>
            ...
            <DIV class=content-box>
                ...
                <DIV class=content-box-content>
                    <DIV id=tab1 class="tab-content default-tab">
                        <!-- This is the target div. id must match the href of this div's tab -->
                        <form action="report4.php" method="post" name="form1" id="form1" target="_blank"
                            onSubmit="return check4(this)">
                            <div class="formArea">
                                <fieldset>
                                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                        <tr>
                                            <td>
                                                <table class="formFields" cellspacing="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td width="90%">
                                                            <select name="cpro" id="cpro" class="inputselect"
                                                                style="width:450px;">
                                                                <?php
                                                                    ...
                                                                    ?>
                                                                <option value="<?php echo $row_qupro1['group_id']; ?>"
                                                                    <?php if ($cpro1 == $row_qupro1['group_id']) {
                                                                                                                                    echo 'selected';
                                                                                                                                } ?>>
                                                            ...
                                                            <a href="javascript:void(0);"
                                                                onClick="windowOpener('400', '500', '', 'search_pro.php?protype=cpro');"><img
                                                                    src="../images/icon2/mark_f2.png" width="25"
                                                                    height="25" border="0" alt=""
                                                                    style="vertical-align:middle;padding-left:5px;"></a>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td nowrap class="name">รายการแสดง</td>
                                                        <td><input name="sh1" type="checkbox" id="sh20" value="1"
                                                                checked>
                                                            ชื่อลูกค้า / บริษัท + เบอร์โทร
                                                            <input name="sh2" type="checkbox" id="sh21" value="1"
                                                                checked>
                                                            ชื่อร้าน / สถานที่ติดตั้ง
                                                            <input name="sh4" type="checkbox" id="sh22" value="1"
                                                                checked>
                                                            ประเภทลูกค้า <br>
                                                            <input name="sh5" type="checkbox" id="sh23" value="1"
                                                                checked>
                                                            กลุ่มลูกค้า
                                                            <input name="sh6" type="checkbox" id="sh24" value="1"
                                                                checked>
                                                            สินค้า
                                                            <input name="sh7" type="checkbox" id="sh25" value="1"
                                                                checked>
                                                            รุ่นเครื่อง/SN/
                                                            <input name="sh8" type="checkbox" id="sh26" value="1"
                                                                checked>
                                                            ราคาขาย/ค่าเช่า
                                                            <input name="sh9" type="checkbox" id="sh27" value="1"
                                                                checked>
                                                            วันที่ติดตั้ง
                                                            <input name="sh10" type="checkbox" id="sh28" value="1"
                                                                checked>
                                                            ผู้ขาย</td>
                                                    </tr>
                                                    <tr>
                                            ...
                                            <td>
                                                <table class="formFields" cellspacing="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td width="90%"><select name="pro_pod" id="pro_pod"
                                                    ...
                                                    <tr>
                                                        <td nowrap class="name">รายการแสดง</td>
                                                        <td><input name="sh1" type="checkbox" id="sh29" value="1"
                                                                checked>
                                                            ชื่อลูกค้า / บริษัท + เบอร์โทร
                                                            <input name="sh2" type="checkbox" id="sh30" value="1"
                                                                checked>
                                                            ชื่อร้าน / สถานที่ติดตั้ง
                                                            <input name="sh4" type="checkbox" id="sh33" value="1"
                                                                checked>
                                                            ประเภทลูกค้า <br>
                                                            <input name="sh5" type="checkbox" id="sh45" value="1"
                                                                checked>
                                                            กลุ่มลูกค้า
                                                            <input name="sh6" type="checkbox" id="sh48" value="1"
                                                                checked>
                                                            สินค้า
                                                            <input name="sh7" type="checkbox" id="sh50" value="1"
                                                                checked>
                                                            รุ่นเครื่อง/SN/
                                                            <input name="sh8" type="checkbox" id="sh51" value="1"
                                                                checked>
                                                            ราคาขาย/ค่าเช่า
                                                            <input name="sh9" type="checkbox" id="sh52" value="1"
                                                                checked>
                                                            วันที่ติดตั้ง</td>
                                                    </tr>
                                                    <tr>
            ...
            <DIV class=content-box>
                ...
                <DIV class=content-box-content>
                    <DIV id=tab1 class="tab-content default-tab">
                        <!-- This is the target div. id must match the href of this div's tab -->
                        <form action="report6.php" method="post" name="form1" id="form1" target="_blank"
                            onSubmit="return check6(this)">
                            <div class="formArea">
                                <fieldset>
                                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                        <tr>
                                            <td>
                                                <table class="formFields" cellspacing="0" width="100%">
                                                    ...
                                                    <tr>
                                                        <td nowrap class="name">รายการแสดง</td>
                                                        <td><input name="sh1" type="checkbox" id="sh54" value="1"
                                                                checked>
                                                            ชื่อลูกค้า / บริษัท + เบอร์โทร
                                                            <input name="sh2" type="checkbox" id="sh55" value="1"
                                                                checked>
                                                            ชื่อร้าน / สถานที่ติดตั้ง

                                                            <input name="sh3" type="checkbox" id="sh57" value="1"
                                                                checked>
                                                            กลุ่มลูกค้า
                                                            <input name="sh4" type="checkbox" id="sh11" value="1"
                                                                checked>
                                                            วันเริ่ม / สิ้นสุดสัญญา<br>
                                                            <input name="sh5" type="checkbox" id="sh59" value="1"
                                                                checked>
                                                            รุ่นเครื่อง/SN/
                                                            <input name="sh6" type="checkbox" id="sh60" value="1"
                                                                checked>
                                                            ราคาขาย/ค่าเช่า
                                                            <input name="sh7" type="checkbox" id="sh12" value="1"
                                                                checked>
                                                            รายการของแถม
                                                            <input name="sh8" type="checkbox" id="sh61" value="1"
                                                                checked>
                                                            วันที่ติดตั้ง
                                                            <input name="sh9" type="checkbox" id="sh13" value="1"
                                                                checked>
                                                            ผู้ขาย</td>
                                                    </tr>
                                                    <tr>
            ...
            <DIV class=content-box>
                ...
                <DIV class=content-box-content>
                    <DIV id=tab1 class="tab-content default-tab">
                        <!-- This is the target div. id must match the href of this div's tab -->
                        <form action="report8.php" method="post" name="form1" id="form1" target="_blank"
                            onSubmit="return check8(this)">
                            <div class="formArea">
                                <fieldset>
                                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                        <tr>
                                            <td>
                                                <table class="formFields" cellspacing="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td width="90%"><input name="cs_company" type="text"
                                                                id="cs_company" value="" size="100"></td>
                                                    </tr>
                                                    <tr>
                                                        <td nowrap class="name">&nbsp;</td>
                                                        <td><span class="name">
            ...
            <DIV class=content-box>
                ...
                <DIV class=content-box-content>
                    <DIV id=tab1 class="tab-content default-tab">
                        <!-- This is the target div. id must match the href of this div's tab -->
                        <form action="report9.php" method="post" name="form1" id="form1" target="_blank"
                            onSubmit="return check9(this)">
                            <div class="formArea">
                                <fieldset>
                                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                        <tr>
                                            <td>
                                                <table class="formFields" cellspacing="0" width="100%">
                                                        ...
                                                        <td width="90%">
                                                            <select name="cs_sell" id="cs_sell" class="inputselect"
                                                                ...
                                                                <?php
                                                                    ...
                                                                    ?>
                                                                <option
                                                                    value="<?php echo $row_saletype['group_id']; ?>">
                                                    ...
                                                    <tr>
                                                        <td nowrap class="name">รายการแสดง</td>
                                                        <td><input name="sh1" type="checkbox" id="sh14" value="1"
                                                                checked>
                                                            ชื่อลูกค้า / บริษัท + เบอร์โทร
                                                            <input name="sh2" type="checkbox" id="sh15" value="1"
                                                                checked>
                                                            ชื่อร้าน / สถานที่ติดตั้ง
                                                            <input name="sh3" type="checkbox" id="sh16" value="1"
                                                                checked>
                                                            จังหวัด
                                                            <input name="sh4" type="checkbox" id="sh17" value="1"
                                                                checked>
                                                            ประเภทลูกค้า <br>
                                                            <input name="sh5" type="checkbox" id="sh18" value="1"
                                                                checked>
                                                            กลุ่มลูกค้า
                                                            <input name="sh6" type="checkbox" id="sh19" value="1"
                                                                checked>
                                                            สินค้า
                                                            <input name="sh7" type="checkbox" id="sh53" value="1"
                                                                checked>
                                                            รุ่นเครื่อง/SN/
                                                            <input name="sh8" type="checkbox" id="sh56" value="1"
                                                                checked>
                                                            ราคาขาย/ค่าเช่า
                                                            <input name="sh9" type="checkbox" id="sh58" value="1"
                                                                checked>
                                                            วันที่ติดตั้ง</td>
                                                    </tr>
                                                    <tr>
                        ...
                        <div class="formArea">
                            <fieldset>
                                <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                    <tr>
                                        <td>
                                            <iframe id="form-iframe" src="control_contact.php"
                                                style="margin:0; width:100%; height:700px; border:none; overflow:hidden;"
                                                scrolling="no" onload="AdjustIframeHeightOnLoad()"></iframe> </td>
                                    </tr>
                                </table>
                            </fieldset>
                        </div><br>
            ...
            <DIV class=content-box>
                ...
                <DIV class=content-box-content>
                    <DIV id=tab1 class="tab-content default-tab">
                        <!-- This is the target div. id must match the href of this div's tab -->
                        <form action="report12.php" method="post" name="form1" id="form1" target="_blank"
                            onSubmit="return check1(this)">
                            <div class="formArea">
                                <fieldset>
                                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                        <tr>
                                            <td>
                                                <table class="formFields" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td>รหัสลูกค้า</td>
                                                        <td><input name="cusid" type="text" id="cusid" value=""
                                                                style="width:40%;">
                                                            <a href="javascript:void(0);"
                                                                onClick="windowOpener('400', '500', '', 'search_id.php');"><img
                                                                    src="../images/icon2/mark_f2.png" width="25"
                                                                    height="25" border="0" alt=""
                                                                    style="vertical-align:middle;padding-left:5px;"></a>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td nowrap class="name">รายการแสดง</td>
                                                        <td><input name="sh1" type="checkbox" id="sh1" value="1"
                                                                checked>
                                                            ชื่อลูกค้า / บริษัท + เบอร์โทร
                                                            ...
                                                            <input name="sh9" type="checkbox" id="sh9" value="1"
                                                                checked>
                                                            วันที่ติดตั้ง
                                                            <input name="sh10" type="checkbox" id="sh10" value="1"
                                                                checked>
                                                            เงินประกัน</td>
                                                    </tr>
                                                    <tr>
                                                ...
                                                <table class="formFields" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td width="10%" nowrap class="name">เริ่มวันที่
                                                            <input type="text" name="date_fm" readonly
                                                                value="<?php if ($_GET['df'] != "") {
                                                            ...
                                                            &nbsp;&nbsp; ถึงวันที่
                                                            <input type="text" name="date_to" readonly
                                                                value="<?php echo date("d/m/Y"); ?>" class="inpfoder" />
                                                            <script language="JavaScript">
                                                            new tcal({
                                                                'formname': 'form1',
                                                        ...
                                                        <td width="90%"><span class="name">
                                                                ...
                                                                ไม่กำหนดช่วงเวลา </span>&nbsp;&nbsp;<input type="submit"
                                    ...
                                    <table width="100%" cellspacing="0" cellpadding="0" border="0"
                                        ...
                                        <tr>
                                            ...
                                            <td><?php
                                                        ...
                                                        ?>
                                                <a href="report1.php?date_fm=<?php echo $datefm; ?>&date_to=<?php echo $dateft; ?>&priod=<?php echo $_GET['poi']; ?>"
                                                    target="_blank"><?php echo number_format($qu_fr1); ?></a></td>
                                    ...
                                    <table width="100%" cellspacing="0" cellpadding="0" border="0"
                                        ...
                                        <tr>
                                            ...
                                            <td><?php
                                                            ...
                                                            $qu_fr1 = @mysqli_num_rows(@mysqli_query($conn, $sql1));
                                                            ?>
                                                <a href="report3.php?date_fm=<?php echo $datefm; ?>&date_to=<?php echo $dateft; ?>&priod=<?php echo $_GET['poi']; ?>&cg_type=<?php echo $roecus['group_id']; ?>"
                                                    target="_blank"><?php echo number_format($qu_fr1); ?></a></td>
                                            <td>รายการ</td>
                                        </tr>
                                        <?php
                                    ...
                                    <table width="100%" cellspacing="0" cellpadding="0" border="0"
                                        ...
                                        <tr>
                                            ...
                                            <td><?php
                                                            ...
                                                            $qu_fr1 = @mysqli_num_rows(@mysqli_query($conn, $sql1));
                                                            ?>
                                                <a href="report5.php?date_fm=<?php echo $datefm; ?>&date_to=<?php echo $dateft; ?>&priod=<?php echo $_GET['poi']; ?>&pro_pod=<?php echo $roepod['group_name']; ?>"
                                                    target="_blank"><?php echo number_format($qu_fr1); ?></a></td>
                                            <td>รายการ</td>
                                        </tr>
                                        <?php
                                    ...
                                    <table width="100%" cellspacing="0" cellpadding="0" border="0"
                                        ...
                                        <tr>
                                            ...
                                            <td><?php
                                                                ...
                                                                $qu_fr1 = @mysqli_num_rows(@mysqli_query($conn, $sql1));
                                                                ?>
                                                <a href="report6.php?date_fm=<?php echo $datefm; ?>&date_to=<?php echo $dateft; ?>&priod=<?php echo $_GET['poi']; ?>&ctype=<?php echo $roetypecus['group_id']; ?>"
                                                    target="_blank"><?php echo number_format($qu_fr1); ?></a></td>
                                            <td>รายการ</td>
                                        </tr>
                                        <?php
                                    ...
                                    <table width="100%" cellspacing="0" cellpadding="0" border="0"
                                        ...
                                        <tr>
                                            ...
                                            <td><?php
                                                            ...
                                                            $qu_fr1 = @mysqli_num_rows(@mysqli_query($conn, $sql1));
                                                            ?>
                                                <a href="report9.php?date_fm=<?php echo $datefm; ?>&date_to=<?php echo $dateft; ?>&priod=<?php echo $_GET['poi']; ?>&cs_sell=<?php echo $roesale['group_id']; ?>"
                                                    target="_blank"><?php echo number_format($qu_fr1); ?></a></td>
                                            <td>รายการ</td>
                                        </tr>
                                        <?php
            ...
            <DIV class=content-box>
                ...
                <DIV class=content-box-header align="right" style="padding-right:15px;">
                    ...
                    <H3 align="left">เลือกตามใบแจ้งงาน</H3>
                    <DIV class=clear>
                ...
                <DIV class=content-box-content>
                    <DIV id=tab1 class="tab-content default-tab">
                        <!-- This is the target div. id must match the href of this div's tab -->
                        <form action="report13.php" method="post" name="form1" id="form1" target="_blank"
                            onSubmit="return check1(this)">
                            <div class="formArea">
                                <fieldset>
                                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                ...
                                                <table class="formFields" cellspacing="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td width="90%"><input name="cd_name" type="text" id="cd_name"
                                                                value="" style="width:40%;"><a
                                                                href="javascript:void(0);"
                                                                onClick="windowOpener('400', '500', '', 'search3.php');"><img
                                                                    src="../images/icon2/mark_f2.png" width="25"
                                                                    height="25" border="0" alt=""
                                                                    style="vertical-align:middle;padding-left:5px;"></a>
                                                            <input name="cus_id" type="hidden" id="cus_id" value="">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="90%">
                                                            <select name="sale_contact" id="sale_contact"
                                                                class="inputselect" style="width:250px;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input name="sh1" type="checkbox" id="sh1" value="1"
                                                            ...
                                                            <input name="sh7" type="checkbox" id="sh7" value="1"
                                                                checked>
                                                            รุ่นเครื่อง/SN/
                                                            <input name="sh11" type="checkbox" id="sh11" value="1"
                                                                checked>
            ...
            <DIV class=content-box>
                ...
                <DIV class=content-box-content>
                    ...
                    <DIV id=tab1 class="tab-content default-tab">
                        <!-- This is the target div. id must match the href of this div's tab -->
                        <form action="report14.php" method="post" name="form1" id="form1" target="_blank"
                            onSubmit="return check3(this)">
                            <div class="formArea">
                                <fieldset>
                                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                        ...
                                                        <td width="90%">
                                                            <select name="pro_pod" id="pro_pod" class="inputselect">
                                                                ...
                                                                <?php
                                                                    ...
                                                                    while ($row_qupros1 = @@mysqli_fetch_array($qupros1)) {
                                                                    ?>
                                                                <option value="<?php echo $row_qupros1['group_id']; ?>">
                                            ...
                                            <td>
                                                <table class="formFields" cellspacing="0" width="100%">
                                                    ...
                                                    <tr>
                                                        <td width="10%" nowrap class="name">ชื่อร้าน-ชื่อบริษัท</td>
                                                        <td width="90%"><input name="cd_name" type="text" id="cd_name"
                                                                value="" style="width:40%;" readonly><a
                                                                href="javascript:void(0);"
