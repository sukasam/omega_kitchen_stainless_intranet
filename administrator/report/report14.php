...
รายงานการรับสินค้าโปรเจ็คเข้าสต๊อค</th>
      ...
      <?php  
		...
		$dbservice = "s_group_stock_project_bill";

		$dbservicesub = "s_group_stock_project_bill_pro";
      ...
      <tr>
			  ...
			  <td colspan="9" style="text-align:right;"> <strong>จำนวนการรับเข้าสต็อคสินค้าโปรเจ็คทั้งหมด&nbsp;&nbsp;<?php  echo $sum;?>&nbsp;&nbsp;รายการ&nbsp;&nbsp;</strong></td>
