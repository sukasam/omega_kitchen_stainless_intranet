    ...
    <DIV id=body-wrapper>
        ...
        <DIV id=main-content>
            ...
            <UL class=shortcut-buttons-set>
                <LI><A class=shortcut-button href="index.php"><SPAN><IMG alt=icon
                ...
                <LI><A class=shortcut-button href="../group_sparpart_stockin/update.php?mode=add"><SPAN><IMG alt=icon
    ...
    ?>
                                    <TR>
                                        ...
                                        <TD style="text-align: center;"><span
                                                class="text"><?php echo $rec["group_spar_id"]; ?></span></TD>
                                        ...
                                        <TD style="text-align: right;"><span
                                                class="text"><?php echo number_format($rec["group_unit_price"], 2); ?></span>
                                        </TD>
                                        <TD style="text-align: right;"><span
                            ...
                            <br><br>
                            <div>
                                <center><a href="print.php?keyword=<?php echo $_GET['keyword']; ?>"
                                        target="_blank"><input class=button name="btprint" type="button"
                                            value="พิมพ์รายการอะไหล่"></a></center>
                            </div>
