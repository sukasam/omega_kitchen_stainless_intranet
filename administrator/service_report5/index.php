	...
	?>
      ...
      <TBODY>
        ...
        <TR>
          ...
          <TD style="vertical-align:middle;"><?php $chaf = preg_replace("/\//","-",$rec["sv_id"]); ?><div align="center"><span class="text"><a href="../../upload/return/<?php echo $chaf;?>.pdf" target="_blank"><? echo $rec["sv_id"] ; ?></a></span></div></TD>
