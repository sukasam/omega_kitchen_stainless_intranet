...
if ($_GET["ff"] != "" and $_GET["gg"] != "") {
    ...
    $code = Check_Permission($conn, 'กำหนดดาว FO/PJ', $_SESSION["login_id"], "update");
    if ($code == "1") {
        $sql_status = "update $tbl_name set status_use = '$status_use' where $PK_field = '" . $_GET["ff"] . "'";
        @mysqli_query($conn, $sql_status);
...
?>"><SPAN><IMG  alt=icon src="../images/pencil_48.png"><BR>
    ...
    FO/PJ<br><br></SPAN></A></LI>
    <LI><A class=shortcut-button href="../fo-pj_approve/index.php"><SPAN><IMG  alt=icon src="../images/icons/icon-48-user.png"><BR>
    อนุมัติใบ FO/PJ (Superviser)</SPAN></A></LI>
    <LI><A class=shortcut-button href="../fo-pj_approve2/index.php"><SPAN><IMG  alt=icon src="../images/icons/icon-48-user.png"><BR>
    อนุมัติใบ FO/PJ (GM)</SPAN></A></LI>
    <LI><A class=shortcut-button href="../group_stock_project_pricelist/index2.php"><SPAN><IMG  alt=icon src="../images/icons/paper_content_pencil_48.png"><BR>
    Price List Stainless</SPAN></A></LI>
...
while ($rec = @mysqli_fetch_array($query)) {
    ...
    ?>
        <TR>
          ...
          <TD style="vertical-align: middle;"><?php $chaf = preg_replace("/\//", "-", $rec["fs_id"]);?><span class="text"><a href="../../upload/fopj/<?php echo $chaf; ?>.pdf" target="_blank" style="<?php echo $GMApprove; ?>"><?php echo $rec["fs_id"]; ?></a></span></TD>
          ...
          <TD nowrap style="vertical-align:middle"><div align="center">
            ...
            <a href="../fo-pj/?ff=<?php echo $rec[$PK_field]; ?>&gg=0&page=<?php echo $_GET['page']; ?>&<?php echo $FK_field; ?>=<?php echo $_REQUEST["$FK_field"]; ?>"><img src="../icons/favorites_use.png" width="15" height="15"> | </a>
            <a href="../fo-pj/?ff=<?php echo $rec[$PK_field]; ?>&gg=1&page=<?php echo $_GET['page']; ?>&<?php echo $FK_field; ?>=<?php echo $_REQUEST["$FK_field"]; ?>"><img src="../icons/favorites_stranby.png" width="15" height="15"> | </a>
            <a href="../fo-pj/?ff=<?php echo $rec[$PK_field]; ?>&gg=2&page=<?php echo $_GET['page']; ?>&<?php echo $FK_field; ?>=<?php echo $_REQUEST["$FK_field"]; ?>"><img src="../icons/favorites_close.png" width="15" height="15"></a>
            </div>
          </div></TD>
          <TD nowrap style="vertical-align:middle"><div align="center">
            <?php if ($rec["st_setting"] == 0) {?>
            <a href="../fo-pj/?b=<?php echo $rec[$PK_field]; ?>&s=<?php echo $rec["st_setting"]; ?>&page=<?php echo $_GET['page']; ?>&<?php echo $FK_field; ?>=<?php echo $_REQUEST["$FK_field"]; ?>"><img src="../icons/status_on.gif" width="10" height="10"></a>
            <?php } else {?>
            <a href="../fo-pj/?b=<?php echo $rec[$PK_field]; ?>&s=<?php echo $rec["st_setting"]; ?>&page=<?php echo $_GET['page']; ?>&<?php echo $FK_field; ?>=<?php echo $_REQUEST["$FK_field"]; ?>"><img src="../icons/status_off.gif" width="10" height="10"></a>
            <?php }?>
          </div></TD>

          <TD style="vertical-align: middle;"><!-- Icons -->
            <a title=Cost href="../fo-pj_cost/update.php?mode=update&<?php echo $PK_field; ?>=<?php echo $rec[$PK_field];if ($param != "") { ?>&<?php echo $param;} ?>"><IMG alt=Edit src="../images/icons/icon-48-stats.png" width="30" height="30" border="0" alt=""></a></TD>
           <TD style="vertical-align: middle;"><div align="center"><a href="../document4/?fo_id=<?php echo $rec[$PK_field]; ?>"><img src="../images/document.png" width="30" height="30" border="0" alt=""></a></div></TD>
