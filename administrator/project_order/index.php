	...
	?>
      ...
      <TBODY>
        ...
        <TR>
          ...
          <TD><span class="text" style="<?php echo $GMApprove;?>"><?php     echo sprintf("%04d",$counter); ?></span></TD>
          <TD><?php     $chaf = preg_replace("/\//","-",$rec["fs_id"]); ?><span class="text"><a href="../../upload/project_order/<?php     echo $chaf;?>.pdf" target="_blank" style="<?php echo $GMApprove;?>"><?php     echo $rec["fs_id"] ; ?></a></span></TD>
          <TD>          <span class="text" style="<?php echo $GMApprove;?>"><?php     echo $rec["cd_name"] ; ?></span></TD>
          <TD><span class="text" style="<?php echo $GMApprove;?>"><?php     echo $rec["loc_name"] ; ?></span></TD>
