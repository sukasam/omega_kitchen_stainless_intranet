...
<DIV id=tab1 class="tab-content default-tab">
  <form action="update2.php" method="post" enctype="multipart/form-data" name="form1" id="form1"  onSubmit="return check(this)">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb1">
	  ...
	  <tr>
	    ...
	    <td><strong>วันที่ปิดงาน  :</strong> <span id="datef"></span><input type="text" name="job_close" readonly value="<? if($job_close==""){echo date("d/m/Y");}else{ echo $job_close;}?>" class="inpfoder"/>
	      <script language="JavaScript">new tcal ({'formname': 'form1','controlname': 'job_close'});</script><span id="datet"></span><input type="hidden" name="job_open" value="<? if($job_open==""){echo date("d/m/Y");}else{ echo $job_open;}?>" class="inpfoder"/><input type="hidden" name="job_balance" value="<? if($job_balance==""){echo date("d/m/Y");}else{ echo $job_balance;}?>" class="inpfoder"/></td>
	    </tr>
	  <tr>
  ...
  <tr>
    ...
    <div class="formArea">
      ...
      <input name="detail_calpr" type="hidden" id="detail_calpr" value="<? echo strip_tags($detail_calpr);?>">
      <input name="detail_recom" type="hidden" id="detail_recom" value="<? echo strip_tags($detail_recom);?>">
