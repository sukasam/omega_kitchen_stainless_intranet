...
?>
            ...
            &nbsp;</TH>
          <TH width="9%"><div align="center"><a>ใบเบิกอะไหล่เพื่อผลิต</a></div></TH>
		  <TH width="9%"><div align="center"><a>เลขใบสั่งผลิต</a></div></TH>
...
while ($rec = @mysqli_fetch_array($query)) {
    ...
    ?>
        <TR>
          ...
          <TD style="vertical-align:middle;"><span class="text"><?php echo $rec["search_op"]; ?></span></TD>
