...
if ($_GET["action"] == "delete") {
    ...
    if ($code == "1") {
        ...
        $sql2 = "select * from s_qc_productsub where sr_id = '" . $_GET[$PK_field] . "'";
        ...
        $sql = "delete from s_qc_productsub  where sr_id = '" . $_GET[$PK_field] . "'";
        @mysqli_query($conn, $sql);
    ...
    <DIV id=body-wrapper>
        ...
        <DIV id=main-content>
            ...
            <UL class=shortcut-buttons-set>
                <!-- <LI><A class=shortcut-button href="../order_product/"><SPAN><IMG alt=icon
                ...
                <LI><A class=shortcut-button href="../qc_product_approve/"><SPAN><IMG alt=icon
                                src="../images/icons/icon-48-user.png"><BR>
                            อนุมัติใบรับตรวจสินค้าสำเร็จรูป</SPAN></A></LI>
                <?php
if ($FR_module != "") {
...
while ($rec = @mysqli_fetch_array($query)) {
    ...
    ?>
                                    <TR>
                                        ...
                                        <TD style="vertical-align:middle;"><span
                                                class="text"><?php echo get_cname_fopj($conn, $rec["cus_id"]); ?></span>
                                        </TD>
                                        <TD style="vertical-align:middle;"><span
                                                class="text"><?php echo get_csetup_fopj($conn, $rec["cus_id"]); ?></span>
                                        </TD>
                                        ...
                                        <TD style="vertical-align:middle">
                                            <div align="center">
                                                ...
                                                <a
                                                    href="../qc_product/?b=<?php echo $rec[$PK_field]; ?>&s=<?php echo $rec["st_setting"]; ?>&page=<?php echo $_GET['page']; ?>&<?php echo $FK_field; ?>=<?php echo $_REQUEST["$FK_field"]; ?>"><img
    ...
    } ?>"><IMG src="../images/icons/paper_content_pencil_48.png" alt=Edit width="25"
                                                        height="25" title="แก้ไข"></A></div>
                                        </TD>
                                        <TD style="vertical-align:middle;">
