...
<?php   
	...
	if($order_pro_info['chkpass1'] === '1'){$chkList1 = 'aroow_ch.png';$chkList11 = 'aroow_nch.png';}else{$chkList1 = 'aroow_nch.png';$chkList11 = 'aroow_ch.png';}
	if($order_pro_info['chkpass2'] === '1'){$chkList2 = 'aroow_ch.png';$chkList12 = 'aroow_nch.png';}else{$chkList2 = 'aroow_nch.png';$chkList12 = 'aroow_ch.png';}
	if($order_pro_info['chkpass3'] === '1'){$chkList3 = 'aroow_ch.png';$chkList13 = 'aroow_nch.png';}else{$chkList3 = 'aroow_nch.png';$chkList13 = 'aroow_ch.png';}
	if($order_pro_info['chkpass4'] === '1'){$chkList4 = 'aroow_ch.png';$chkList14 = 'aroow_nch.png';}else{$chkList4 = 'aroow_nch.png';$chkList14 = 'aroow_ch.png';}
	if($order_pro_info['chkpass5'] === '1'){$chkList5 = 'aroow_ch.png';$chkList15 = 'aroow_nch.png';}else{$chkList5 = 'aroow_nch.png';$chkList15 = 'aroow_ch.png';}
	if($order_pro_info['chkpass6'] === '1'){$chkList6 = 'aroow_ch.png';$chkList16 = 'aroow_nch.png';}else{$chkList6 = 'aroow_nch.png';$chkList16 = 'aroow_ch.png';}
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" style="text-align:center;"  class="tb4">
      <tr>
		...
		<td width="33%" style="border:1px solid #000000;font-size:10px;font-family:Verdana, Geneva, sans-serif;text-align:center;padding-top:10px;padding-bottom:10px;">
        	<table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td style="border-bottom:1px solid #000000;padding-bottom:23px;font-size:10px;font-family:Verdana, Geneva, sans-serif;text-align:center;">'.$_POST['loc_contact3'].'<br></td>
              </tr>
              <tr>
