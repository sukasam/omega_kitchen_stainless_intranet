...
<UL class=shortcut-buttons-set>
  <!-- <LI><A class=shortcut-button href="update.php?mode=add<?php     if ($param <> "") echo "&".$param; ?>"><SPAN><IMG  alt=icon src="../images/pencil_48.png"><BR>
    ...
    ใบแจ้งงาน</SPAN></A></LI> -->
    <LI><A class=shortcut-button href="../fo-pj/"><SPAN><IMG  alt=icon src="../images/btn_back.gif" width="32"><BR><BR>
  กลับ</SPAN></A></LI>
	...
	?>
      ...
      <TBODY>
        ...
        <TR>
         ...
         <TD style="vertical-align: middle;"><?php  $chaf = preg_replace("/\//","-",$rec["fs_id"]); ?><span class="text"><a href="../../upload/fopj/<?php  echo $chaf;?>.pdf" target="_blank"><?php  echo $rec["fs_id"] ; ?></a></span></TD>
         ...
         <center>
          ...
          <TD style="vertical-align: middle;"><div align="center"><a href="../../upload/fopj/<?php  echo $chaf;?>.pdf" target="_blank"><img src="../images/icon2/download_f2.png" width="20" height="20" border="0" alt=""></a></div></TD>
