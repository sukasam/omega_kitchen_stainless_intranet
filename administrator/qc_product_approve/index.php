<?php    
	...
	if ($_GET["action"] == "apps") {
		...
		if ($cc == 1) {
			...
			if ($appID == '') $appID = '0';
			$sql_status = "update $tbl_name set approve = '" . $cc . "', loc_contact3 = '', loc_date3 = '" . date("Y-m-d") . "' where $PK_field = '" . $ids . "'";
			//exit();
			@mysqli_query($conn, $sql_status);
		}
		//exit();

		header("Location:update.php?mode=update&sr_id=" . $ids);
	}
...
<UL class=shortcut-buttons-set>
	<!-- <LI><A class=shortcut-button href="../order_product/"><SPAN><IMG  alt=icon src="../images/icons/icon-48-category.png"><BR>
	ใบสั่ง<br>ผลิตสินค้า</SPAN></A></LI> 
	<LI><A class=shortcut-button href="../qc_product/"><SPAN><IMG  alt=icon src="../images/icons/icon-48-section.png"><BR>
	ใบตรวจสินค้าสำเร็จรูป</SPAN></A></LI> 
    <LI><A class=shortcut-button href="../qc_product_approve/"><SPAN><IMG  alt=icon src="../images/icons/icon-48-user.png"><BR>
	อนุมัติใบตรวจสินค้าสำเร็จรูป</SPAN></A></LI>  -->
    ...
    <TABLE>
      <THEAD>
        <TR>
		  ...
		  <TH width="5%"><div align="center"><a>ลำดับ.</a></div></TH>
          <TH width="10%"><div align="center"><a>เลขที่</a></div></TH>
          <TH width="15%"><a>ชื่อลูกค้า</a></TH>
          <TH width="15%"><a>สถานที่ติดตั้ง</a></TH>
          <TH width="10%"><div align="left"><a>เลขที่ FO/PJ</a></div></TH>
		  <TH width="10%"><div align="left"><a>พนักงานขาย</a></div></TH>
		  <TH width="10%"><div align="left"><a>กำหนดเสร็จ</a></div></TH>
          <TH width="10%"><div align="center"><a>การยืนยัน</a></div></TH>
          <TH width="10%"><div align="center"><a>Download</a></div></TH>
...
//					break;
        ...
        <TR>
          ...
          <TD style="vertical-align:middle;"><?php     $chaf = preg_replace("/\//","-",$rec["sv_id"]); ?><div align="center"><span class="text"><a href="../../upload/order_product/<?php     echo $chaf;?>.pdf" target="_blank"><?php     echo $rec["sv_id"] ; ?></a></span></div></TD>
          <TD style="vertical-align:middle;"><span class="text"><?php     echo get_cname_fopj($conn,$rec["cus_id"]); ?></span></TD>
          <TD style="vertical-align:middle;"><span class="text"><?php     echo get_csetup_fopj($conn,$rec["cus_id"]); ?></span></TD>
          <TD style="vertical-align:middle;"><?php  echo $rec["search_fo"];?></TD>
		  <TD style="vertical-align:middle;"><?php  echo get_csale_fopj($conn,$rec["cus_id"]);;?></TD>
		  <TD style="vertical-align:middle;"><?php  echo format_date_th ($rec["job_balance"],7);?></TD>
        ...
        <TD style="vertical-align:middle;"><?php     $chaf = preg_replace("/\//","-",$rec["sv_id"]); ?><div align="center"><span class="text"><a href="../../upload/order_product/<?php     echo $chaf;?>.pdf" target="_blank"><img src="../images/icon2/backup.png" width="25" height="25" title="ดาวน์โหลดรายงานช่างซ่ิอม" style="margin-left:10px;"></a></span></div></TD>
          </TR>  
		<?php     }?>
      </TBODY>
    </TABLE>
