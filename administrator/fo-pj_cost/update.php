...
<HEAD>
    ...
    function download(id) {
        window.open("../../upload/fopj_cost/PJC " + id + ".pdf", '_blank');
    }
                                    ...
                                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                        <tr>
                                            <td style="padding-bottom:5px;"><img
                                                    src="../images/form/header-project-order-cost.png" width="100%"
                                                    border="0" /></td>
                                        </tr>
                                    </table>
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb1">
                                        <tr>
                                            <td
                                                ...
                                                <strong>ชื่อลูกค้า :</strong> <input type="text" name="cd_name"
                                                    value="<?php echo $cd_name; ?>" id="cd_name" class="inpfoder"
                                                    style="width:70%;" readonly></td>
                                            <td
                                                style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;">
...
?>
                                            ...
                                            <td
                                                style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;">
                                                <strong>เลขที่ใบเสนอราคา / PO.NO. :</strong> <input type="text"
                                                    name="po_id" value="<?php echo $po_id; ?>" id="po_id"
                                                    class="inpfoder" readonly></td>
                                        </tr>
                                        <tr>
                                            <td
                                                style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;">
                                                <strong>โทรศัพท์ :</strong> <input type="text" name="cd_tel"
                                                    value="<?php echo $cd_tel; ?>" id="cd_tel" class="inpfoder"
                                                    readonly>
                                                <strong>แฟกซ์ :</strong>
                                                <input type="text" name="cd_fax" value="<?php echo $cd_fax; ?>"
                                                    id="cd_fax" class="inpfoder" readonly></td>
                                            <td
                                                style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;">
                                        ...
                                        <tr>
                                            <td
                                                ...
                                                <input type="text" name="c_contact" value="<?php echo $c_contact; ?>"
                                                    id="c_contact" class="inpfoder" readonly>
                                                <strong>เบอร์โทร :</strong>
                                                <input type="text" name="c_tel" value="<?php echo $c_tel; ?>" id="c_tel"
                                                    class="inpfoder" readonly></td>
                                            <td
                                                style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;">
                                                <strong>รหัสลูกค้า<strong> :</strong><span
                                                        style="font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;">
                                                        <input type="text" name="cusid" value="<?php echo $cusid; ?>"
                                                            id="cusid" class="inpfoder" readonly>
                                                    </span></strong></td>
                                        </tr>
                                    </table>
                                    <br>
                                    <table width="100%" border="1" cellspacing="0" cellpadding="0"
                                        style="border:1px solid #000000;" class="tb2">
                                        <tr>
...
-->
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <table width="100%" border="0" cellspacing="0"
                                                                            cellpadding="0" class="tb2">
                                                                            <tr>
                                                                                <td
                                                                                    style="font-size:15px;font-family:Verdana, Geneva, sans-serif;padding:5px;">
                                                                                    <strong>สรุปค่าใช้จ่าย :
                                                                                        ฝ่ายควบคุมงาน</strong>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td
    ...
    echo 'checked';
                                                                                    ...
                                                                                    <input type="text" name="shipC2"
                                                                                        value="<?php echo number_format($shipC2, 2); ?>"
                                                                                        id="shipL2" class="inpfoder"
                                                                                        onkeypress="return isNumberKey(event)">
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
    ...
    echo 'checked';
                                                                                    ...
                                                                                    <input type="text" name="shipC6"
                                                                                        value="<?php echo number_format($shipC6, 2); ?>"
                                                                                        id="shipL6" class="inpfoder"
                                                                                        onkeypress="return isNumberKey(event)">
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
    ...
    echo 'checked';
                                                                            ...
                                                                            <tr>
                                                                                <td
                                                                                    style="font-size:15px;font-family:Verdana, Geneva, sans-serif;padding:5px;">
                                                                                    <strong>รวมค่าใช้จ่าย
                                                                                        (ฝ่ายควบคุมงาน):
                                                                                        <?php echo number_format($shipC8, 2); ?></strong>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td
                                                                                        ...
                                                                                        <strong>ค่าน้ำมัน :</strong>
                                                                                        <input type="text" name="shipM1"
                                                                                            value="<?php echo number_format($shipM1, 2); ?>"
                                                                                            id="shipM1" class="inpfoder"
                                                                                            onkeypress="return isNumberKey(event)">
                                                                                    </td>
                                                                                </tr>
                                                                                <tr class="alt-row">
                                                                                    <td
                                                                                        ...
                                                                                        <strong>ค่าเดินทาง (อื่นๆ)
                                                                                            :</strong>
                                                                                        <input type="text" name="shipM2"
                                                                                            value="<?php echo number_format($shipM2, 2); ?>"
                                                                                            id="shipM2" class="inpfoder"
                                                                                            onkeypress="return isNumberKey(event)">
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td
                                                                                        ...
                                                                                        <strong>ค่าทางด่วน :</strong>
                                                                                        <input type="text" name="shipM3"
                                                                                            value="<?php echo number_format($shipM3, 2); ?>"
                                                                                            id="shipM3" class="inpfoder"
                                                                                            onkeypress="return isNumberKey(event)">
                                                                                    </td>
                                                                                </tr>
                                                                                <tr class="alt-row">
                                                                                    <td
                                                                                        ...
                                                                                        <strong>ค่าเบี้ยเลี้ยง
                                                                                            :</strong>
                                                                                        <input type="text" name="shipM4"
                                                                                            value="<?php echo number_format($shipM4, 2); ?>"
                                                                                            id="shipM4" class="inpfoder"
                                                                                            onkeypress="return isNumberKey(event)">
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td
                                                                                        ...
                                                                                        <strong>ค่าขนส่งสินค้า
                                                                                            :</strong>
                                                                                        <input type="text" name="shipM5"
                                                                                            value="<?php echo number_format($shipM5, 2); ?>"
                                                                                            id="shipM5" class="inpfoder"
                                                                                            onkeypress="return isNumberKey(event)">
                                                                                ...
                                                                                <tr>
                                                                                    <td
                                                                                        ...
                                                                                        <input type="text" name="shipM6"
                                                                                            value="<?php echo number_format($shipM6, 2); ?>"
                                                                                            id="shipM6" class="inpfoder"
                                                                                            onkeypress="return isNumberKey(event)">
                                                                                ...
                                                                                <tr class="alt-row">
                                                                                    <td
                                                                                        ...
                                                                                        <strong>ค่าใช้จ่ายเบ็ตเตล็ด
                                                                                            :</strong>
                                                                                        <input type="text" name="shipM7"
                                                                                            value="<?php echo number_format($shipM7, 2); ?>"
                                                                                            id="shipM7" class="inpfoder"
                                                                                            onkeypress="return isNumberKey(event)">
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td
                                                                                        ...
                                                                                        <strong>อื่นๆ ระบุ :</strong>
                                                                                        <input type="text" name="shipM8"
                                                                                            value="<?php echo number_format($shipM8, 2); ?>"
                                                                                            id="shipM8" class="inpfoder"
                                                                                            onkeypress="return isNumberKey(event)">
                                                                                    </td>
                                                                                </tr>
                                                                                <tr class="alt-row">
                                                                                    <td
                                                                                        style="font-size:15px;font-family:Verdana, Geneva, sans-serif;padding:5px;">
                                                                                        <strong>รวมค่าใช้จ่าย (โรงงาน):
                                                                                            <?php echo number_format($shipM9, 2); ?></strong>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
    ...
    echo 'checked';
                                                                                    ...
                                                                                    <input type="text" name="shipL2"
                                                                                        value="<?php echo number_format($shipL2, 2); ?>"
                                                                                        id="shipL2" class="inpfoder"
                                                                                        onkeypress="return isNumberKey(event)">
                                                                                </td>
                                                                            </tr>
    ...
    echo 'checked';
                                                                                    ...
                                                                                    <input type="text" name="shipL6"
                                                                                        value="<?php echo number_format($shipL6, 2); ?>"
                                                                                        id="shipL6" class="inpfoder"
                                                                                        onkeypress="return isNumberKey(event)">
                                                                                </td>
                                                                            </tr>
    ...
    echo 'checked';
                                                                            ...
                                                                            <tr>
                                                                                <td
                                                                                    style="font-size:15px;font-family:Verdana, Geneva, sans-serif;padding:5px;">
                                                                                    <strong>รวมค่าใช้จ่าย (ฝ่ายขาย):
                                                                                        <?php echo number_format($shipL8, 2); ?></strong>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
    ...
    ?>
                                            <tr>
                                                ...
                                                <td style="border:1px solid #000000;text-align:left;padding:5;">
                                                    <input type="hidden" name="cproH[]"
                                                        value="<?php echo $rowPro['cpro']; ?>">
                                                    <select name="cpro[]" id="cpro<?php echo $rowCal; ?>"
    ...
    echo '0';
                                        ...
                                        <tr style="display: none;">
                                            <td colspan="9"
                                                ...
                                                <!--<textarea name="ccomment" id="ccomment" ><?php echo strip_tags($ccomment); ?></textarea>--><?php echo strip_tags($ccomment); ?><br>
                                            </td>
                                        </tr>
                                    ...
                                    function addExp() {
                                        ...
                                        filedMore +=
                                            '	<td style="border:1px solid #000000;text-align:left;padding:5;">';
                                        filedMore += '		<select name="cpro[]" id="cpro' + countBox +
                                            '" class="inputselect" style="width:90%;">';
                                        filedMore += '		<option value="">กรุณาเลือกรายการ</option>';
                                        filedMore += '';
                                        filedMore += '	</select>';
                                        filedMore +=
                                            '<a href="javascript:void(0);" onClick="windowOpener(\'400\', \'500\', \'\', \'search.php?protype=cpro' +
                                            countBox +
                                            '\');"><img src="../images/icon2/mark_f2.png" width="25" height="25" border="0" alt="" style="vertical-align:middle;padding-left:5px;"></a>';
                                        filedMore += '	</td>';
                                        filedMore +=
                                            '	<td style="border:1px solid #000000;padding:5;text-align:center;" >';
                                        filedMore += '		<input type="text" name="cpod[]" value="" id="cpod' + countBox +
                                            '" class="inpfoder" style="width:100%;text-align:center;"></td>';
                                        filedMore +=
                                            '	<td style="border:1px solid #000000;padding:5;text-align:center;" >';
                                        filedMore += '		<input type="text" name="csn[]" value="" id="csn' + countBox +
                                            '" class="inpfoder" style="width:100%;text-align:center;"></td>';
                                        filedMore +=
                                            '	<td style="border:1px solid #000000;padding:5;text-align:center;">';
                                        filedMore += '		<input type="text" name="camount[]" value="" id="camount' +
                                            countBox + '" class="inpfoder" style="width:100%;text-align:center;"></td>';
                                        filedMore +=
                                            '	<td style="border:1px solid #000000;padding:5;text-align:center;">';
                                        filedMore += '		<input type="text" name="cprice[]" value="" id="cprice' +
                                            countBox + '" class="inpfoder" style="width:100%;text-align:center;"></td>';
                                        filedMore += '</tr>';
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                        ...
                                        <tr>
                                            <td style="border:0;padding:0;width:60%;vertical-align:top;display: none;">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        ...
                                                        <th width="75%"
                                                            style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;text-align:center;">
                                                            <strong>รายการแถม</strong></th>
                                                        <th width="15%"
                                                            style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;text-align:center;">
                                                            <strong>จำนวน</strong></th>
                                                    </tr>
                                                    <tr>
                                                        <td
                                                            style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;text-align:center;">
                                                        ...
                                                        <td
                                                            style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;">
                                                            <input type="text" name="cs_pro1"
                                                                value="<?php echo $cs_pro1; ?>" id="cs_pro1"
                                                                class="inpfoder" style="width:90%;height:27px;"></td>
                                                        <td
                                                            style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;text-align:center;">
                                                            <input type="text" name="cs_amount1"
                                                                value="<?php echo $cs_amount1; ?>" id="cs_amount1"
                                                                class="inpfoder"
                                                                style="width:90%;text-align:center;height:27px;"></td>
                                                    </tr>
                                                    <tr>
                                                        <td
                                                            style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;text-align:center;">
                                                        ...
                                                        <td
                                                            style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;">
                                                            <input type="text" name="cs_pro2"
                                                                value="<?php echo $cs_pro2; ?>" id="cs_pro2"
                                                                class="inpfoder" style="width:90%;height:27px;"></td>
                                                        <td
                                                            style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;text-align:center;">
                                                            <input type="text" name="cs_amount2"
                                                                value="<?php echo $cs_amount2; ?>" id="cs_amount2"
                                                                class="inpfoder"
                                                                style="width:90%;text-align:center;height:27px;"></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td
                                                            style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;">
                                                            <input type="text" name="cs_pro3"
                                                                value="<?php echo $cs_pro3; ?>" id="cs_pro3"
                                                                class="inpfoder" style="width:90%;height:27px;"></td>
                                                        <td
                                                            style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;text-align:center;">
                                                            <input type="text" name="cs_amount3"
                                                                value="<?php echo $cs_amount3; ?>" id="cs_amount3"
                                                                class="inpfoder"
                                                                style="width:90%;text-align:center;height:27px;"></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td
                                                            style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;">
                                                            <input type="text" name="cs_pro4"
                                                                value="<?php echo $cs_pro4; ?>" id="cs_pro4"
                                                                class="inpfoder" style="width:90%;height:27px;"></td>
                                                        <td
                                                            style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;text-align:center;">
                                                            <input type="text" name="cs_amount4"
                                                                value="<?php echo $cs_amount4; ?>" id="cs_amount4"
                                                                class="inpfoder"
                                                                style="width:90%;text-align:center;height:27px;"></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td
                                                            style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;">
                                                            <input type="text" name="cs_pro5"
                                                                value="<?php echo $cs_pro5; ?>" id="cs_pro5"
                                                                class="inpfoder" style="width:90%;height:27px;"></td>
                                                        <td
                                                            style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;text-align:center;">
                                                            <input type="text" name="cs_amount5"
                                                                value="<?php echo $cs_amount5; ?>" id="cs_amount5"
                                                                class="inpfoder"
                                                                style="width:90%;text-align:center;height:27px;"></td>
                                                    </tr>
                                                </table>
                                            ...
                                            <td
                                                style="border:0;padding:0;width:40%;vertical-align:top;padding-left:5px;font-size:12px;border:1px solid #000000;padding-top:10px;">
                                                <p><strong>
                                                        เลขที่สัญญาซื้อขาย : <input type="text" name="r_id"
...
;?>" id="r_id" class="inpfoder" >--><br><br>
    ...
    echo $date_qut;
                                                    ...
                                                    <div id="cssign"><strong>ผู้มีอำนาจเซ็นสัญญา</strong>
                                                        <input type="text" name="cs_sign"
                                                            value="<?php echo $cs_sign; ?>" id="cs_sign"
                                                            class="inpfoder" style="width:50%;" readonly>
                                                        <br><br>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                        ...
                                        <tr>
                                            <td width="50%"
                                                ...
                                                <strong>บุคคลติดต่อทางด้านการเงิน : <input type="text" name="cs_contact"
                                                        value="<?php echo $cs_contact; ?>" id="cs_contact"
                                                        class="inpfoder" style="width:50%;" readonly></strong></td>
                                            <td width="50%"
                                                style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:10px;">
                                                <strong>โทรศัพท์ : </strong><input type="text" name="cs_tel"
                                                    value="<?php echo $cs_tel; ?>" id="cs_tel" class="inpfoder"
                                                    style="width:50%;" readonly></td>
                                        </tr>
                                        <tr>
                                            <td
                                                style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:10px;">
    ...
    echo $cs_setting;
                                        ...
                                        <tr>
                                            <td
                                                style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:10px;">
                                                <strong>การบริการ : </strong><strong>
...
?>
                                                                ...
                                                                <strong><input type="text" name="cs_company"
                                                                        value="<?php echo $cs_company; ?>"
                                                                        id="cs_company" class="inpfoder"
...
?>
                                                    ...
                                                    <tr>
                                                        <td style="padding-top:10px;padding-bottom:10px;font-size:12px;font-family:Verdana, Geneva, sans-serif;text-align:center;"
                                                            disabled><strong>พนักงานขาย</strong></td>
                                                    </tr>
                                                    <tr>
                                                        <td
                                                            style="font-size:12px;font-family:Verdana, Geneva, sans-serif;text-align:center;">
                                            ...
                                            <td width="33%"
                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td
                                                            style="border-bottom:1px solid #000000;padding-bottom:10px;font-size:12px;font-family:Verdana, Geneva, sans-serif;text-align:center;">
                                                            <strong><input type="text" name="cs_aceep"
                                                                    value="<?php echo $cs_aceep; ?>" id="cs_aceep"
                                                                    class="inpfoder"
                                                                    style="width:50%;text-align:center;"
                                                                    readonly></strong></td>
                                                    </tr>
                                                    <tr>
                                                        <td
                                                            style="padding-top:10px;padding-bottom:10px;font-size:12px;font-family:Verdana, Geneva, sans-serif;text-align:center;">
                                                            <strong>ผู้อนุมัติการขาย</strong></td>
                                                    </tr>
                                                    <tr>
                                                        <td
                                                            style="font-size:12px;font-family:Verdana, Geneva, sans-serif;text-align:center;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                        ...
                                        <tr>
                                            <td width="33%"
                                                style="border:1px solid #000000;font-size:12px;font-family:Verdana, Geneva, sans-serif;text-align:left;padding-top:10px;padding-bottom:10px;">
...
?>
                                ...
                                <input name="status_use" type="hidden" id="status_use"
                                    value="<?php echo $status_use; ?>">
                                <input name="st_setting" type="hidden" id="st_setting"
